$(function () {
	...
	var coverCon = document.getElementsByClassName('coverCon')[0];
	var quesEditor = document.getElementsByClassName('quesEditor')[0];
	var similar = document.getElementsByClassName('similar')[0];
}());